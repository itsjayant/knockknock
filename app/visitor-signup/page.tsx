            ...
            <div className="w-full max-w-md space-y-6">
                ...
                <div className="text-center space-y-2">
                    <div className="flex justify-center">
                        <PersonAddIcon className="!text-5xl text-black" />
                    </div>
                    <h1 className="text-3xl font-bold text-black">Create Account</h1>
                    <p className="text-gray-700">Sign up to identify yourself when ringing</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 bg-white pl-10 pr-4 py-2 text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <EmailIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 !text-lg" />
                            <input
                                type="email"
                                name="email"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <LockIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 !text-lg" />
                            <input
                                type="password"
                                name="password"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-lg bg-black px-4 py-3 font-semibold text-white hover:bg-gray-900 active:bg-black disabled:opacity-50 transition-all"
                    >
                ...
                <div className="text-center">
                    <p className="text-slate-600">
                        ...
                        <Link href="/visitor-signin" className="font-semibold text-black hover:text-gray-700">
                            Log in
                        </Link>
                    </p>
                </div>
